...
public class eval_evalua207 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval2Pregu07OpcionVerdadero;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua207);
        ...
        // PREGUNTA 7 ------------------------------------------------------------------------------------------
        rdnEval2Pregu07OpcionVerdadero = (RadioButton)findViewById(R.id.rdnEval2Pre07);
        // PREGUNTA 7 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 7 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta07 (View view) {
        if (rdnEval2Pregu07OpcionVerdadero.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =7;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua208.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg07 (View view){
