...
public class eval_evalua09 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval1Pregu09Opcion3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua09);
        ...
        // PREGUNTA 9 ------------------------------------------------------------------------------------------
        rdnEval1Pregu09Opcion3 = (RadioButton)findViewById(R.id.rdnEval1Pre09);
        // PREGUNTA 9 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 9 ---------------------------------------------------------------------------------------------
    public void Evaluacion1Pregunta09 (View view) {

        if (rdnEval1Pregu09Opcion3.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =9;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua10.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion1Preg09 (View view){
