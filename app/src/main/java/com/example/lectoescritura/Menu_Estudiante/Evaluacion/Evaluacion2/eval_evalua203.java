...
public class eval_evalua203 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval2Pregu03Opcion1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua203);
        ...
        // PREGUNTA 3 ------------------------------------------------------------------------------------------
        rdnEval2Pregu03Opcion1 = (RadioButton)findViewById(R.id.rdnEval2Pre03);
        // PREGUNTA 3 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 3 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta03 (View view) {

        if (rdnEval2Pregu03Opcion1.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =3;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua204.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg03 (View view){
