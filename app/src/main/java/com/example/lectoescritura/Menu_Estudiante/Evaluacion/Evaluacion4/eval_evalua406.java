...
public class eval_evalua406 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval4Pregu06OpcionFalso;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua406);
        ...
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
        rdnEval4Pregu06OpcionFalso = (RadioButton)findViewById(R.id.rdnEval4Pre06);
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 6 ---------------------------------------------------------------------------------------------
    public void Evaluacion4Pregunta06 (View view) {
        if (rdnEval4Pregu06OpcionFalso.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =6;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua407.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion4Preg06 (View view){
        score = 0;
        pregunta =6;
        BD_usuario();
        Intent intent = new Intent(this, eval_evalua407.class);
