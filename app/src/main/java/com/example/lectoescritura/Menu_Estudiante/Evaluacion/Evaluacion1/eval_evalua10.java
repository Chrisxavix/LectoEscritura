...
public class eval_evalua10 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval1Pregu10OpcionVerdadero;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua10);
        ...
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
        rdnEval1Pregu10OpcionVerdadero = (RadioButton)findViewById(R.id.rdnEval1Pre10);
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 10 ---------------------------------------------------------------------------------------------
    public void Evaluacion1Pregunta10 (View view) {
        if (rdnEval1Pregu10OpcionVerdadero.isChecked() == true) {
            ...
            BD_usuario();
            PuntajeFinal();
            ToastBien("Felicidades, ha terminado la Evaluacion 1.");
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion1Preg10 (View view){
    ...
    public void PuntajeFinal () {
        ...
        if (notafinal == 0) {
            ...
            registro.put("notafinal", notafinal);
            BaseFinal.insert("tb_notaseval1", null, registro);
            BaseFinal.close();
