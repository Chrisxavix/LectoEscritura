...
public class eval_evalua310 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval3Pregu10OpcionVerdadero;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua310);
        ...
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
        rdnEval3Pregu10OpcionVerdadero = (RadioButton)findViewById(R.id.rdnEval3Pre10);
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 10 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta10 (View view) {
        if (rdnEval3Pregu10OpcionVerdadero.isChecked() == true) {
            ...
            BD_usuario();
            PuntajeFinal();
            ToastBien("Felicidades, ha terminado la Evaluacion 3.");
            finish();
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg10 (View view){
    ...
    public void PuntajeFinal () {
        ...
        if (notafinal == 0) {
            ...
            registro.put("notafinal", notafinal);
            BaseFinal.insert("tb_notaseval3", null, registro);
            BaseFinal.close();
