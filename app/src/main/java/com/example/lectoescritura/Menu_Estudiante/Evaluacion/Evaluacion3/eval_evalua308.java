...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion2.eval_evalua205;
import com.example.lectoescritura.R;

public class eval_evalua308 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval3Pregu08Opcion3;
    private ImageView Ima_pregunta8;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua308);
        ...
        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------
        Glide.with(getBaseContext()).load(R.drawable.evaluacion3_08).into(Ima_pregunta8);
        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------

        // PREGUNTA 8 ------------------------------------------------------------------------------------------
        rdnEval3Pregu08Opcion3 = (RadioButton)findViewById(R.id.rdnEval3Pre08);
        // PREGUNTA 8 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 8 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta08 (View view) {

        if (rdnEval3Pregu08Opcion3.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =8;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua309.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg08 (View view){
