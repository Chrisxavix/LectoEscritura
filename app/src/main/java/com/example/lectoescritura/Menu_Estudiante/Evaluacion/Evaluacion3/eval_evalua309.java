...
public class eval_evalua309 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval3Pregu09Opcion3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua309);
        ...
        // PREGUNTA 9 ------------------------------------------------------------------------------------------
        rdnEval3Pregu09Opcion3 = (RadioButton)findViewById(R.id.rdnEval3Pre09);
        // PREGUNTA 9 ------------------------------------------------------------------------------------------

    }

    // PREGUNTA 9 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta09 (View view) {

        if (rdnEval3Pregu09Opcion3.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =9;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua310.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg09 (View view){
