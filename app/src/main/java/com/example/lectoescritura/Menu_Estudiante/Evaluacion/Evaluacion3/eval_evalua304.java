...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion2.eval_evalua204;
import com.example.lectoescritura.R;

public class eval_evalua304 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval3Pregu04Opcion2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua304);
        ...
        // PREGUNTA 4 ------------------------------------------------------------------------------------------
        rdnEval3Pregu04Opcion2 = (RadioButton)findViewById(R.id.rdnEval3Pre04);
        // PREGUNTA 4 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 4 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta04 (View view) {

        if (rdnEval3Pregu04Opcion2.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =4;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua305.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg04 (View view){
