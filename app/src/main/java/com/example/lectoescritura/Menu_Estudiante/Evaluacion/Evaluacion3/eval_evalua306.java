...
public class eval_evalua306 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval3Pregu06Opcion1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua306);
        ...
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
        rdnEval3Pregu06Opcion1 = (RadioButton)findViewById(R.id.rdnEval3Pre06);
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 6 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta06 (View view) {

        if (rdnEval3Pregu06Opcion1.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =6;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua307.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg06 (View view){
