...
public class eval_simu10 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnSimuPregu10OpcionFalso;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_simu10);
        ...
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
        rdnSimuPregu10OpcionFalso = (RadioButton)findViewById(R.id.rdnSimuPre10);
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
    }


    // PREGUNTA 10 ---------------------------------------------------------------------------------------------
    public void SimulacionPregunta10 (View view) {
        if (rdnSimuPregu10OpcionFalso.isChecked() == true) {
            ...
            BD_usuario();
            PuntajeFinal();
            ToastBien("Felicidades, ha terminado la simulación.");
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeSimuPreg10 (View view){
    ...
    public void PuntajeFinal () {
        ...
        if (notafinal == 0) {
            ...
            registro.put("notafinal", notafinal);
            BaseFinal.insert("tb_notas", null, registro);
            BaseFinal.close();
