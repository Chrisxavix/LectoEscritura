...
public class eval_evalua06 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval1Pregu06Opcion2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua06);
        ...
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
        rdnEval1Pregu06Opcion2 = (RadioButton)findViewById(R.id.rdnEval1Pre06);
        // PREGUNTA 6 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 6 ---------------------------------------------------------------------------------------------
    public void Evaluacion1Pregunta06 (View view) {

        if (rdnEval1Pregu06Opcion2.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =6;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua07.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion1Preg06 (View view){
