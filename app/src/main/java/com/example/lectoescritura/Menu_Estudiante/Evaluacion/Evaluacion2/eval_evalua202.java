...
public class eval_evalua202 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval2Pregu02Opcion2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua202);
        ...
        // PREGUNTA 2 ------------------------------------------------------------------------------------------
        rdnEval2Pregu02Opcion2 = (RadioButton)findViewById(R.id.rdnEval2Pre02);
        // PREGUNTA 2 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 2 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta02 (View view) {

        if (rdnEval2Pregu02Opcion2.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =2;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua203.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg02 (View view){
