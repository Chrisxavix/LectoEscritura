...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion2.eval_evalua206;
import com.example.lectoescritura.R;

public class eval_evalua307 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxEval3Pregu07Op2, cbxEval3Pregu07Op3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua307);
        ...
        // PREGUNTA 7 ------------------------------------------------------------------------------------------
        cbxEval3Pregu07Op2 = (CheckBox)findViewById(R.id.cbxEval3Pre07_op2);
        cbxEval3Pregu07Op3 = (CheckBox)findViewById(R.id.cbxEval3Pre07_op3);
        // PREGUNTA 7 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 7 ---------------------------------------------------------------------------------------------
    public void Evaluacion3Pregunta07 (View view) {

        if ((cbxEval3Pregu07Op2.isChecked() == true && cbxEval3Pregu07Op3.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =7;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua308.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion3Preg07 (View view){
