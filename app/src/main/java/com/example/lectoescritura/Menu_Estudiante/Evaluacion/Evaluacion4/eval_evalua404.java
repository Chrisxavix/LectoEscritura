...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion3.eval_evalua303;
import com.example.lectoescritura.R;

public class eval_evalua404 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval4Pregu04OpcionVerdadero;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua404);
        ...
        // PREGUNTA 4 ------------------------------------------------------------------------------------------
        rdnEval4Pregu04OpcionVerdadero = (RadioButton)findViewById(R.id.rdnEval4Pre04);
        // PREGUNTA 4 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 4 ---------------------------------------------------------------------------------------------
    public void Evaluacion4Pregunta04 (View view) {
        if (rdnEval4Pregu04OpcionVerdadero.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =4;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua405.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion4Preg04 (View view){
        score = 0;
        pregunta =4;
        BD_usuario();
        Intent intent = new Intent(this, eval_evalua405.class);
