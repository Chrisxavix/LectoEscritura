...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion3.eval_evalua309;
import com.example.lectoescritura.R;

public class eval_evalua403 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval4Pregu03Opcion2;
    private ImageView Ima_pregunta3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua403);
        ...
        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------
        Glide.with(getBaseContext()).load(R.drawable.evaluacion4_03).into(Ima_pregunta3);
        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------

        // PREGUNTA 3 ------------------------------------------------------------------------------------------
        rdnEval4Pregu03Opcion2 = (RadioButton)findViewById(R.id.rdnEval4Pre03);
        // PREGUNTA 3 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 3 ---------------------------------------------------------------------------------------------
    public void Evaluacion4Pregunta03 (View view) {

        if (rdnEval4Pregu03Opcion2.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =3;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua404.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion4Preg03 (View view){
        score = 0;
        pregunta =3;
        BD_usuario();
        Intent intent = new Intent(this, eval_evalua404.class);
