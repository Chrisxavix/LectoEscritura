...
public class eval_evalua210 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval2Pregu10OpcionFalso;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua210);
        ...
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
        rdnEval2Pregu10OpcionFalso = (RadioButton)findViewById(R.id.rdnEval2Pre10);
        // PREGUNTA 10 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 10 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta10 (View view) {
        if (rdnEval2Pregu10OpcionFalso.isChecked() == true) {
            ...
            BD_usuario();
            PuntajeFinal();
            ToastBien("Felicidades, ha terminado la Evaluacion 2.");
            finish();
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg10 (View view){
    ...
    public void PuntajeFinal () {
        ...
        if (notafinal == 0) {
            ...
            registro.put("notafinal", notafinal);
            BaseFinal.insert("tb_notaseval2", null, registro);
            BaseFinal.close();
