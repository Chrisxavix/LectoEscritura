...
public class eval_evalua05 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxEval1Pregu05Op1, cbxEval1Pregu05Op3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua05);
        ...
        // PREGUNTA 5 ------------------------------------------------------------------------------------------
        cbxEval1Pregu05Op1 = (CheckBox)findViewById(R.id.cbxEval1Pre05_op1);
        cbxEval1Pregu05Op3 = (CheckBox)findViewById(R.id.cbxEval1Pre05_op3);
        // PREGUNTA 5 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 5 ---------------------------------------------------------------------------------------------
    public void Evaluacion1Pregunta05 (View view) {

        if ((cbxEval1Pregu05Op1.isChecked() == true && cbxEval1Pregu05Op3.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =5;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua06.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion1Preg05 (View view){
