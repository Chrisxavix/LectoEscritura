...
public class eval_evalua209 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxEval2Pregu09Op1, cbxEval2Pregu09Op3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua209);
        ...
        // PREGUNTA 9 ------------------------------------------------------------------------------------------
        cbxEval2Pregu09Op1 = (CheckBox)findViewById(R.id.cbxEval2Pre09_op1);
        cbxEval2Pregu09Op3 = (CheckBox)findViewById(R.id.cbxEval2Pre09_op3);
        // PREGUNTA 9 ------------------------------------------------------------------------------------------

    }

    // PREGUNTA 9 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta09 (View view) {

        if ((cbxEval2Pregu09Op1.isChecked() == true && cbxEval2Pregu09Op3.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =9;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua210.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg09 (View view){
