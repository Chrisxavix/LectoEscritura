...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Simulacion.eval_simu06;
import com.example.lectoescritura.R;

public class eval_evalua02 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxEval1Pregu02Op1, cbxEval1Pregu02Op3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua02);
        ...
        // PREGUNTA 2 ------------------------------------------------------------------------------------------
        cbxEval1Pregu02Op1 = (CheckBox)findViewById(R.id.cbxEval1Pre02_op1);
        cbxEval1Pregu02Op3 = (CheckBox)findViewById(R.id.cbxEval1Pre02_op3);
        // PREGUNTA 2 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 2 ---------------------------------------------------------------------------------------------
    public void Evaluacion1Pregunta02 (View view) {

        if ((cbxEval1Pregu02Op1.isChecked() == true && cbxEval1Pregu02Op3.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =2;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua03.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion1Preg02 (View view){
