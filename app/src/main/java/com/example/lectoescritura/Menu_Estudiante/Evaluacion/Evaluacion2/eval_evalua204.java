...
public class eval_evalua204 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private RadioButton rdnEval2Pregu04Opcion1;
    private ImageView Ima_pregunta4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua204);
        ...
        Ima_pregunta4 = (ImageView)findViewById(R.id.Ima_pregunta4);
        // VALIDACION DE LOS IDs DEL XML -------------------------------------------------------------------------

        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------
        Glide.with(getBaseContext()).load(R.drawable.evaluacion2_04).into(Ima_pregunta4);
        // CARGADO DE LOS GIFS -----------------------------------------------------------------------------------

        // PREGUNTA 4 ------------------------------------------------------------------------------------------
        rdnEval2Pregu04Opcion1 = (RadioButton)findViewById(R.id.rdnEval2Pre04);
        // PREGUNTA 4 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 4 ---------------------------------------------------------------------------------------------
    public void Evaluacion2Pregunta04 (View view) {

        if (rdnEval2Pregu04Opcion1.isChecked() == true) {

            score = 1;
            notafinal++;
            pregunta =4;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua205.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion2Preg04 (View view){
