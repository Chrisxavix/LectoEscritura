...
import com.example.lectoescritura.Menu_Estudiante.Evaluacion.Evaluacion3.eval_evalua308;
import com.example.lectoescritura.R;

public class eval_evalua405 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxEval4Pregu05Op1, cbxEval4Pregu05Op2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_evalua405);
        ...
        // PREGUNTA 5 ------------------------------------------------------------------------------------------
        cbxEval4Pregu05Op1 = (CheckBox)findViewById(R.id.cbxEval4Pre05_op1);
        cbxEval4Pregu05Op2 = (CheckBox)findViewById(R.id.cbxEval4Pre05_op2);
        // PREGUNTA 5 ------------------------------------------------------------------------------------------

    }

    // PREGUNTA 5 ---------------------------------------------------------------------------------------------
    public void Evaluacion4Pregunta05 (View view) {

        if ((cbxEval4Pregu05Op1.isChecked() == true && cbxEval4Pregu05Op2.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =5;
            BD_usuario();
            Intent intent = new Intent(this, eval_evalua406.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeEvaluacion4Preg05 (View view){
        score = 0;
        pregunta =5;
        BD_usuario();
        Intent intent = new Intent(this, eval_evalua406.class);
