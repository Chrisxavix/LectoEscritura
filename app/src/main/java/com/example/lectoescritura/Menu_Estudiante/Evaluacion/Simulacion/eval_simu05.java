...
public class eval_simu05 extends AppCompatActivity {
    int score;
    int notafinal;
    int pregunta;
    ...
    private CheckBox cbxSimuPregu05Op1, cbxSimuPregu05Op3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eval_simu05);
        ...
        // PREGUNTA 5 ------------------------------------------------------------------------------------------
        cbxSimuPregu05Op1 = (CheckBox)findViewById(R.id.cbxSimuPre05_op1);
        cbxSimuPregu05Op3 = (CheckBox)findViewById(R.id.cbxSimuPre05_op3);
        // PREGUNTA 5 ------------------------------------------------------------------------------------------
    }

    // PREGUNTA 5 ---------------------------------------------------------------------------------------------
    public void SimulacionPregunta05 (View view) {

        if ((cbxSimuPregu05Op1.isChecked() == true && cbxSimuPregu05Op3.isChecked() == true))  {

            score = 1;
            notafinal++;
            pregunta =5;
            BD_usuario();
            Intent intent = new Intent(this, eval_simu06.class);
    ...
    // NO RESPONDE ----------------------------------------------------------------------------------------------
    public void NoRespondeSimuPreg05 (View view){
